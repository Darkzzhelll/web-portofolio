import { WrenchScrewdriverIcon, ClipboardIcon, CommandLineIcon, ForwardIcon, PencilIcon } from "@heroicons/react/24/outline";
    ...
    <section className="bg-aksen relative">
      ...
      <div className="py-8 base:py-16 mx-8 base:mx-16">
        ...
        <div className="flex flex-col lg:flex-row justify-between mt-16 mx-16">  
          ...
          <div className="flex flex flex-col-reverse lg:flex-row lg:items-end lg:justify-end">
        ...
        {/* Skill baris 3 */}
        <div className="flex justify-center items-center mt-6 lg:mt-32 ">
          ...
          <PencilIcon className="block h-16 w-auto stroke-secondary2 stroke-1"/>
            <p className="text-base font-medium self-center text-secondary2 w-80 ">
              Cukup memahami dasar dan pengoperasian Adobe photoshop dan Illustrator
            </p>
          </div>
        </div>
      </div>
